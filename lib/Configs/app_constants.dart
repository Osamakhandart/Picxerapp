...
final fiberchatPRIMARYcolor = Color(0xff2873ff); //changed by JH 0xFF4D0036
// you may change this as per your theme. This applies to large buttons, tabs, text heading etc.
final fiberchatSECONDARYolor = Color(
    0xff4928ff); //changed by JH IMPORTANT: Has to have contrast in dark and bright mode!  Ich hatte auch mal  0,137,179,0.8
// you may change this as per your theme. This applies to small buttons, icons & highlights

const SplashBackgroundSolidColor = Color.fromARGB(255, 255, 255, 255);
...
// light mode colors -----
final fiberchatAPPBARcolorLightMode = Color.fromARGB(255, 255, 255, 255);
...
final fiberchatBACKGROUNDcolorDarkMode = Color.fromARGB(255, 0, 0, 0);
final fiberchatCONTAINERboxColorDarkMode = Color(0xff111920);
final fiberchatDIALOGColorDarkMode =
    Color.fromARGB(255, 0, 0, 0); //changed by JH
...
final fiberchatCHATBUBBLEcolor =
    Color.fromARGB(255, 212, 227, 255); //changed by JH
final fiberchatGreenColorAccent = Color.fromARGB(255, 0, 150,
    0); //changed by JH for progress bar in Video editor! IF I change again, then adjust video editor according to Anleitung!
...
const AppLogoPathDarkModeLogo =
    'assets/images/applogo_dark.png'; //changed by JH because was other way round
const AppLogoPathLightModeLogo = 'assets/images/applogo_light.png';
