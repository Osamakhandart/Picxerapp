...
const int ImageQualityCompress = 99;
...
const IsHIDELightDarkModeSwitchInApp =
    false; //changed by JH because looks not good
//If 'true', the app will not have dark or light mode switch

const IsShowLightDarkModeSwitchInLoginScreen = false;
