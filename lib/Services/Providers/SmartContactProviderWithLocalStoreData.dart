...
import 'package:fiberchat/Services/helpers/jh_sendWelcomeMessage.dart';
...
//-------
  ...
  searchAvailableContactsInDb(BuildContext context, String currentuserphone,
      SharedPreferences existingPrefs, bool isForceFetch,
      {DataModel? model}) async {
    if (existingPrefs.getString('lastTimeCheckedContactBookSavedCopy') ==
            ...
            for (QueryDocumentSnapshot<Map<String, dynamic>> registeredUser
              ...
              if (registeredUser.data().containsKey(Dbkeys.joinedOn)) {
                if (alreadyJoinedSavedUsersPhoneNameAsInServer.indexWhere(
                  ...
                  //added by JH
                  print("CodeAv: registeredUser.data()[Dbkeys.phone] running");
                  print("CodeAv: registeredUser.data()[Dbkeys.phone]" +
                      registeredUser.data()[Dbkeys.phone].toString());
                  if (registeredUser.data()[Dbkeys.phone] != '') {
                    newContactsInContactbookWhoHavePicxer[
                            registeredUser.data()[Dbkeys.phone]] =
                        registeredUser.data()[Dbkeys.publicKey];
                  }
      ...
      print("CodeAv: alreadyJoinedSavedUsersPhoneNameAsInServer: " +
          alreadyJoinedSavedUsersPhoneNameAsInServer.length.toString());
      print("CodeAv: previouslyFetchedKEYPhoneInSharedPrefs: " +
          previouslyFetchedKEYPhoneInSharedPrefs.length.toString());
      print("CodeAv: newContactsInContactbookWhoHavePicxer: " +
          newContactsInContactbookWhoHavePicxer.length.toString());
      //added by JH
      checkAndSendWelcomeMessage(currentuserphone,
          newContactsInContactbookWhoHavePicxer, model, context);
      //added by JH until here
