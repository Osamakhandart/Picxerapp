...
class _InitializeState extends State<Initialize> {
  ...
  initialise() async {
    ...
    // Added by JH: Put timeout limit when loading chat FirebaseStorage content
    // This resolves the issue with not being able to load the cache of messages
    // instead when there is a poor connection
    FirebaseStorage.instance
        .setMaxOperationRetryTime(const Duration(seconds: 2));
