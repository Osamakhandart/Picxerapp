...
class LoginScreenState extends State<LoginScreen>
  ...
  //added by JH:
  String phoneNoWithoutFirstZero(String phoneNoToCut) {
    String phoneNumberWithoutNull =
        phoneNoToCut.replaceAll(new RegExp(r'^0+(?=.)'), '');
    return phoneNumberWithoutNull;
  }
  ...
  Future<void> verifyPhoneNumber() async {
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      debugPrint(
          'Authentication failed -ERROR: ${authException.message}. Try again later. Code: ${authException.code} Plugin: ${authException.plugin} Stacktrace: ${authException.stackTrace}');
    ...
    try {
      await firebaseAuth.verifyPhoneNumber(
          phoneNumber:
              (phoneCode! + phoneNoWithoutFirstZero(_phoneNo.text)).trim(),
  ...
  subscribeToNotification(String currentUserNo, bool isFreshNewAccount) async {
    ...
    await FirebaseMessaging.instance
        .subscribeToTopic('allusers_picxerversion' + packageInfo.version);
    print("subscribed to " + 'allusers_picxerversion' + packageInfo.version);
  ...
  Future<Null> handleSignIn({AuthCredential? authCredential}) async {
    ...
    var phoneNo = (phoneCode! + phoneNoWithoutFirstZero(_phoneNo.text)).trim();
        ...
        if (documents.length == 0) {
          ...
          if (fcmTokenn != null) {
            ...
            await FirebaseFirestore.instance
              ...
              Dbkeys.phoneRaw: phoneNoWithoutFirstZero(_phoneNo.text),
              ...
              Dbkeys.phonenumbervariants: phoneNumberVariantsList(
                  ...
                  phonenumber: phoneNoWithoutFirstZero(_phoneNo.text))
                      ...
                      child: Column(
                        children: <Widget>[
                              ...
                              onpressed: widget.isblocknewlogins == true
                                  ...
                                  : () {
                                      ...
                                      if (_name.text.trim().isNotEmpty) {
                                        String _phone = phoneNoWithoutFirstZero(
                                                _phoneNo.text)
                                            .toString()
                                            .trim();
                          ...
                          ListTile(
                            ...
                            title: Text(
                              getTranslated(context, 'problemslogin'),
                              maxLines: 1,
                            ...
                            subtitle: Padding(
                              ...
                              child: Text(
                                getTranslated(context, 'problemslogindescr'),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
          ...
          Padding(
            ...
            child: Text(
              getTranslated(this.context, 'sending_code') +
                  ' $phoneCode-${phoneNoWithoutFirstZero(_phoneNo.text)}',
              textAlign: TextAlign.center,
              style: TextStyle(
                  height: 1.5,
